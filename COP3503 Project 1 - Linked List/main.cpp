...
This part assumes you have written all functionality from the previous part.
*/
...
/*
For this part you will implement functionality to insert elements into the linked list, one of the primary advantages of this data structure. (This can be achieved with arrays as well, but it is much faster with a linked list).
...
InsertAfter()
InsertAt()
In addition, you will implement the equality operator, to test if two lists are equal to one another.
...
/*
In this last part you are going to implement various functions to remove nodes from the list, the other two members of the Big Three, as well as an alternate way of iterating through your nodes to print them using recursion. You'll implement the following:
